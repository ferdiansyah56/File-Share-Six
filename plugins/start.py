    ...
    if len(text) > 7:
        ...
        buttons = [
            ...
            [
                ...
                InlineKeyboardButton("ᴄʜᴀɴɴᴇʟ ɪᴠ", url=client.invitelink5),
            ],
            [
                InlineKeyboardButton("ᴄʜᴀɴɴᴇʟ ᴠ", url=client.invitelink6),
                InlineKeyboardButton("ᴄʜᴀɴɴᴇʟ ᴠɪ", url=client.invitelink2),
            ],
            [
